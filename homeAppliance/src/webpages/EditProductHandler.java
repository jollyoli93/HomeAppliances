...
public class EditProductHandler implements HttpHandler {
    ...
    public void handle(HttpExchange he) throws IOException {
        ...
        try {
            ...
            Appliance appliance = appliances.getAppliance(Integer.parseInt(id));
            ...
            if ( appliance != null) {
                out.write(
                    ...
                    "      <input type=\"text\" class=\"form-control\" id=\"description\" name=\"description\" value=\"" + appliance.getDescription() + "\">" +
                    "    </div>" +
                    "    <div class=\"form-group\">" +
                    "      <label for=\"category\">Category</label>" +
                    "      <input type=\"text\" class=\"form-control\" id=\"category\" name=\"category\" value=\"" + appliance.getCategory() + "\">" +
                    "    </div>" +
                    "    <div class=\"form-group\">" +
                    ...
                    "      <input type=\"text\" class=\"form-control\" id=\"sku\" name=\"sku\" value=\"" + appliance.getSku() + "\">" +
                    "    </div>" +
